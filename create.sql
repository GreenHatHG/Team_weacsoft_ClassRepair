...
) ENGINE=InnoDB AUTO_INCREMENT=10329 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='课室表';
...
CREATE TABLE `qa_type` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10009 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='常见故障分类表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `qa_type` VALUES (10001,1580100644,0,1,0,1,'电脑',''),(10002,1580100644,0,1,0,2,'无线麦',''),(10003,1580100644,0,1,0,3,'鹅颈麦',''),(10004,1580100644,0,1,0,4,'投影',''),(10005,1580100644,0,1,0,5,'灯',''),(10006,1580100644,0,1,0,6,'风扇',''),(10007,1580100644,0,1,0,7,'空调',''),(10008,1580100644,0,1,0,8,'其他问题','');
...
CREATE TABLE `repair_item` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='报修表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `repair_log` (
  ...
  `repair_item_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '报修单id，后端自动生成，规则：当前日期+时间戳前十一位数字，2020012715801331743',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='报修表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `repair_log` VALUES (1,1582726385,0,1,0,'do ut dolore','202002244814418'),(2,1582727210,0,1,0,'111','202002245796304'),(3,1582727436,0,1,0,'1213','202002264965758'),(4,1582727503,0,1,0,'543252346','20200226353903'),(5,1582727545,0,1,0,'1231241','202002264750698'),(6,1582727612,0,1,0,'3413','202002262469835');
...
CREATE TABLE `time_table` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='值班表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `time_table` VALUES (1,1582715968,0,2,1582715969,29),(3,1583208362,0,2,1584860100,2),(4,1585548877,0,1,0,2),(5,1590300648,0,1,0,34);
...
-- Dump completed on 2020-05-24 15:07:14
