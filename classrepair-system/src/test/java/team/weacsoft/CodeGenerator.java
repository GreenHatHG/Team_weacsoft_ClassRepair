...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("team.weacsoft." + scanner("包名"));
        ...
        strategy.setSuperEntityClass(team.weacsoft.common.persistence.BaseEntity.class);
        strategy.setEntityLombokModel(true);
        strategy.setRestControllerStyle(true);
        // 公共父类
//        strategy.setSuperControllerClass("你自己的父类控制器,没有就不用设置!");
        // 写于父类中的公共字段
        strategy.setSuperEntityColumns("id", "state", "create_time", "update_time", "delete_time");
