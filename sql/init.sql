...
CREATE TABLE `material` (
  ...
  `amount` int NOT NULL DEFAULT '100' COMMENT '材料数量',
  ...
  `update_time` bigint unsigned NOT NULL COMMENT '更新时间戳',
  `material_type_id` int unsigned NOT NULL COMMENT '材料类型id',
  PRIMARY KEY (`id`)
...
CREATE TABLE `material_type` (
  ...
  `name` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '分类名',
  `sort` int DEFAULT NULL COMMENT '排序',
  `tree_path` varchar(25) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '树路径',
  `create_time` bigint unsigned NOT NULL COMMENT '创建时间戳',
  `delete_time` bigint unsigned NOT NULL COMMENT '删除时间戳，软删除',
  `state` tinyint NOT NULL COMMENT '一般1为启用，0为停用，-1为删除,特殊情况除外',
  `update_time` bigint unsigned NOT NULL COMMENT '更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='备件材料分类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `material_type` VALUES (1,'sunt reprehei',1,'',1597921100,0,1,0),(2,'in',1,'',1597921970,0,1,0),(3,'in quis sunt',1,'',1597922003,0,1,0),(4,'in quis sunt',1,'',1597922003,0,1,0),(5,'in quis sunt',1,'',1597922004,0,1,0),(6,'in quis sunt',1,'',1597922005,0,1,0),(7,'in quis sunt',1,'',1597922005,0,1,0),(8,'in quis sunt',1,'',1597922006,0,1,0);
...
CREATE TABLE `time_table` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='值班表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `time_table` VALUES (1,1582715968,0,2,1582715969,29),(3,1583208362,0,2,1584860100,2),(4,1585548877,0,2,1590314215,2),(5,1590300648,0,2,1590317756,34),(6,1590318578,0,1,0,6),(7,1590318640,0,2,1595090617,34),(8,1595090618,0,2,1595177919,34),(9,1595177921,0,1,0,34),(10,1598856249,0,2,1598856251,2);
...
-- Dump completed on 2020-08-31 16:28:08
